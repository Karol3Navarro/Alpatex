...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username= 'jorgitocode', password = '12345')
        self.usuario_b = User.objects.create(username= 'dosusuario', password = '12345')
        self.usuario_c = User.objects.create(username= 'usuarioc', password = '12345')
